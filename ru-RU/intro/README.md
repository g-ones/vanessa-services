...
[[Прочитайте какой должен быть компьютер|Положение-о-(кошерном)-компьютере-разработчика-1С]]
### Windows

* [[Ознакомитесь с инструкцией по установке|ИнструкцияПоНастройкеРабочегоОкружения]]
